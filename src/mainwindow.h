...
private slots:
  ...
  /**
   * @brief při kliknutí na tlačítko AC vynuluje pole primary, secondary a
   * operand
   */
  ...
  /**
   * @brief při kliknutí na tlačítko 10x přidá 2 nuly na konec pole primary
   * (popřípadě přidá desetinnou tečku)
   */
  ...
  /**
   * @brief při kliknutí na tlačítko = nastaví pole primary na výsledek
   * požadované operace
   */
  ...
  /**
   * @brief při kliknutí na tlačítko "odmocnina" nastaví pole operand na
   * "odmocnina"
   */
